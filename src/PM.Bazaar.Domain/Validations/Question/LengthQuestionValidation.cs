...
namespace PM.Bazaar.Domain.Validations.Question
{
    public class LengthQuestionValidation : Validation<Domain.Entities.Question>
    {
        ...
        public override IResult IsValid(Entities.Question entity)
        {
